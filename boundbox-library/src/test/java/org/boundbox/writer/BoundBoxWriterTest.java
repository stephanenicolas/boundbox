...
public class BoundBoxWriterTest {
    ...
    @Test
    public void testProcess_class_with_inherited_static_initializer() throws Exception {
        // given
        String classUnderTestName = "TestClassWithInheritedStaticInitializer";
        List<String> neededClasses = new ArrayList<String>();
        neededClasses.add("TestClassWithStaticInitializer");
        ...
        classInfo.setListMethodInfos(listMethodInfos);
        classInfo.setListImports(new HashSet<String>());
        classInfo.getListSuperClassNames().add("TestClassWithStaticInitializer");
        ...
        Method method = clazz.getDeclaredMethod("boundBox_super_TestClassWithStaticInitializer_static_init");
        assertNotNull(method);
        assertTrue((method.getModifiers() & Modifier.STATIC) != 0);
    }
